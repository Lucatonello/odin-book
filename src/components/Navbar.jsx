    ...
    return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
            ...
            <div className={styles.navItems}>
                ...
                <div className={styles.navItem}>
                <svg onClick={() => navigate('/messaging')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" className={tab === 'notifications' ? styles.active : styles.inactive} width="24" height="24" focusable="false">
