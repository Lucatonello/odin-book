        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
            ...
            <div className={styles.navItems}>
                <div className={styles.navItem}>
                    <svg onClick={() => navigate('/')} fill="currentColor" className={tab == 'home' ? styles.active : styles.inactive} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                {type == 'user' && (
                    <div className={styles.navItem}>
                        <svg onClick={() => navigate('/network')} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={tab === 'network' ? styles.active : styles.inactive} viewBox="0 0 24 24" >
                ...
                <div className={styles.navItem}>
                    <svg onClick={() => navigate('/notifications')} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={tab === 'notifications' ? styles.active : styles.inactive} viewBox="0 0 24 24">
                ...
                <div className={styles.navItem}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" className={tab === 'notifications' ? styles.active : styles.inactive} width="24" height="24" focusable="false">
