        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
            ...
            <div className={styles.navItems}>
                ...
                {type !== 'company' && (
                    <>
                        <div className={styles.navItem}>
                            <svg fill={tab.tab === "messaging" ? '#1a1a1a' : '#666666'} onClick={() => navigate('/messaging')} xmlns="http://www.w3.org/2000/svg" className={styles.inactive} viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" className={tab === 'notifications' ? styles.active : styles.inactive} width="24" height="24" focusable="false">
