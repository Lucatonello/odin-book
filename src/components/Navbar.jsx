        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
            ...
            <div className={styles.navItems}>
                <div className={styles.navItem}>
                    <svg onClick={() => navigate('/')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={styles.icon}>
                ...
                <div className={styles.navItem}>
                    <svg onClick={() => navigate('/jobs')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={styles.icon}>
